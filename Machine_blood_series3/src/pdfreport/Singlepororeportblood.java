...
public class Singlepororeportblood {
	...
	//	c2.setBackgroundColor(backcellcoltable1);
		...
		r1.setBorder(1);
		r1.setBorder(r1.TOP | r1.LEFT);
		r1.setBorderColor(resultborder);
		r1.setBackgroundColor(backcellcoltable);
		r1.setFixedHeight(18f);
		r1.setHorizontalAlignment(Element.ALIGN_CENTER);
		r1.setVerticalAlignment(Element.ALIGN_TOP);


		PdfPCell r2 = new PdfPCell(new Paragraph("Time",
				sampleinfola));
		// r1 = new PdfPCell(new Phrase("jj"+d.starttime));
		r2.setBorder(1);
		r2.setBorder(r2.TOP);
		...
		r2.setFixedHeight(18f);
		r2.setHorizontalAlignment(Element.ALIGN_CENTER);
		r2.setVerticalAlignment(Element.ALIGN_TOP);
		...
		r3.setFixedHeight(18f);
		r3.setHorizontalAlignment(Element.ALIGN_CENTER);
		r3.setVerticalAlignment(Element.ALIGN_TOP);
		
		
		PdfPCell r4 = new PdfPCell(new Paragraph("Overall Results ",
				sampleinfola));
		// r4 = new PdfPCell(new Phrase("jj"+d.starttime));
		
		r4.setRowspan(1);
		r4.setBackgroundColor(backcellcoltable);
		r4.setBorder(1);
		r4.setBorder(r4.TOP | r4.RIGHT);
		r4.setBorderColor(resultborder);
		r4.setFixedHeight(18f);
		r4.setHorizontalAlignment(Element.ALIGN_CENTER);
		r4.setVerticalAlignment(Element.ALIGN_TOP);

		/* LABEL */
		resulttable.addCell(r1);
		resulttable.addCell(r2);
		resulttable.addCell(r3);
		resulttable.addCell(r4);
		
		PdfPCell u1 = new PdfPCell(new Paragraph("( kPa )", unitlab));
		u1.setBorder(1);
		u1.setBorder(u1.LEFT| u1.BOTTOM);
		u1.setBorderColor(resultborder);
		u1.setFixedHeight(18f);
		...
		PdfPCell u2 = new PdfPCell(new Paragraph("( Min )", unitlab));
		u2.setBorder(1);
		u2.setBorder(u2.BOTTOM);
		u2.setBorderColor(resultborder);
		u2.setFixedHeight(18f);
		...
		PdfPCell u3 = new PdfPCell(new Paragraph("", unitlab));
		u3.setBorder(1);
		u3.setBorder( u3.BOTTOM);
		u3.setBorderColor(resultborder);
		u3.setFixedHeight(18f);
		...
		PdfPCell u4 = new PdfPCell(new Paragraph("", unitlab));
		u4.setBorder(1);
		u4.setBorder(u4.RIGHT | u4.BOTTOM);
		u4.setBorderColor(resultborder);
		u4.setFixedHeight(18f);
		u4.setBackgroundColor(backcellcoltable);
		u4.setHorizontalAlignment(Element.ALIGN_CENTER);
		u4.setVerticalAlignment(Element.ALIGN_TOP);
		

		resulttable.addCell(u1);
		resulttable.addCell(u2);
		resulttable.addCell(u3);
		resulttable.addCell(u4);
		...
		for (int j = 0; j < bpoint.size(); j++) {
			...
			PdfPCell r1r = new PdfPCell(new Paragraph(bpoint.get(j),
					sampleinfoans));
			r1r.setBorder(1);
			...
			PdfPCell r3r = new PdfPCell(new Paragraph(bresult.get(j),sampleinfoans));
			r3r.setBackgroundColor(backcellcoltable1);
			r3r.setBorder(1);
			r3r.setBorder(r3r.BOTTOM| r3r.RIGHT);
			r3r.setBorderColor(resultborder);
			r3r.setFixedHeight(18f);
